...
def is_valid_response(resp):
    ...
    return (resp.status_code == 200 and
            ("<ResponseCode>0000</ResponseCode>" in resp.text or
             ...
             "<ResponseCode>00</ResponseCode>" in resp.text or
             "<ResponseCode>0</ResponseCode>" in resp.text or
             "<ResponseCode>1</ResponseCode>" in resp.text or
             "<ResponseCode>2</ResponseCode>" in resp.text
             ))
